...
class ConfigValidation(BaseModel):
    ...
    SIMILARITY_THRESHOLD: float = Field(ge=0.0, le=1.0, description="Similarity detection threshold")
    MAX_CONSECUTIVE_SIMILAR: int = Field(ge=1, le=10, description="Max similar responses before termination")
