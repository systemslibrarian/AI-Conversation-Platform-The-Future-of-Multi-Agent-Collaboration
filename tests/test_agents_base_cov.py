...
class DummyQueue:
    ...
    async def get_last_sender(self): return None
    async def is_terminated(self): return False
    async def mark_terminated(self, *a, **k): pass
    async def get_termination_reason(self): return ""
